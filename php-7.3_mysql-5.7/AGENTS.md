...
Hlavnou stratégiou pri vývoji nového IS jej vyhnuť sa programovaniu, pokiaľ je to možné a namiesto programovania použiť existujúce <@todo> moduly a ich konfiguráciu. Tam, kde toto nie je možné, sa pozadovaná funkcionalita pridáva buď formou vlastného alebo vendor modulu.
