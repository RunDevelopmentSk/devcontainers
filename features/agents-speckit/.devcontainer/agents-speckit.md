...
Devcontainer feature [`agents-speckit`](https://github.com/RunDevelopmentSk/devcontainers). Adds [speckit tools](https://github.com/github/spec-kit) for AI agents.

It only makes sense to add this feature if the `agents` feature is already added.

## Installation

Copy the contents of the `features/agents-speckit` folder into the project folder.
